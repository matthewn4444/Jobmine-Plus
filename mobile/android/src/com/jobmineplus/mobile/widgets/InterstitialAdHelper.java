...
public class InterstitialAdHelper {
     ...
     */
    static final private int OFTEN_OPENED_SMALL_VALUE = 20;
    static final private int OFTEN_OPENED_SMALL_STEP = 3;
...
//        Toast.makeText(mAct, percentage + "% | R: " + rPercent + "%", Toast.LENGTH_SHORT).show();
